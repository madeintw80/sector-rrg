...
(function () {
  ...
  const SCOREBOARD = [
    ...
    },
    {
      ...
      verdict: { cls: "dead", label: "❌ 死亡" },
      note: "2026-08-28 判死（research/rrg_early_bird_backtest.py，事前宣告制、對帳七重）；「提早進場」E1/E2/U 三度全滅＝蓋棺：訊號只能等確認、不能搶跑。分辨器（d≈0.6~1.2）是真訊息但蓋不過搶跑的結構性負超額；near 型（V 拉）分辨器續集保留待開；本頁三訊號不受影響",
    },
  ];
